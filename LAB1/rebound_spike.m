...
ylabel('u(t)')
grid on;
title('(M) rebound spike (membrane potential)');
print(fig,'images/rebound_spike_membrane_potential.png','-dpng')
...
print(fig,'images/rebound_spike_phase_portrait.png','-dpng')