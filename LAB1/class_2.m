...
ylabel('u(t)')
grid on;
title('(H) Class 2 exc. (membrane potential)');
print(fig,'images/class_2_membrane_potential.png','-dpng')
...
ylabel('w')
axis equal
title('(H) Class 2 exc. (phase portrait)');
print(fig,'images/class_2_phase_portrait.png','-dpng')